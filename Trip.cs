...
namespace Mary
{
    class Trip
    {
        ...
        static public void UpdateTripBtn()
        {
            ...
            {
                case 1:
                    ButtonFactory.tripInfo.Text = Settings.UNITKPH ? "^7Dst: " + Math.Round(Program.MySelf.P.tripDst / 1000, 1) + " km" : "^7" + Math.Round(Program.MySelf.P.tripDst / 1000 * 0.621371192, 1) + " miles";
                    break;
                case 2:
                    ButtonFactory.tripInfo.Text = ("^7Time: " + tripWatch.Elapsed.ToString(@"hh\:mm\:ss"));
                    break;
                case 3:
                    double speedInKilometresPerHour = (Program.MySelf.P.tripDst / 1000) / TimeSpan.Parse(tripWatch.Elapsed.ToString(@"hh\:mm\:ss")).TotalHours;
                    ...
                    break;
                case 4:
                    ButtonFactory.tripInfo.Text = "^7Max: " + Program.MySelf.P.topSpeed + (Settings.UNITKPH ? " kph" : " mph");
                    break;
            }
